      ...
      <section className="pt-32 pb-16 bg-secondary hero-pattern">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <span className="text-foreground">Коробка 300x200x200</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Компактная гофрокоробка для упаковки и хранения товаров небольшого размера
              </p>
            ...
            <div className="relative">
              <img
                src={corrugatedBoxes}
                alt="Коробка 300x200x200 TuranPET"
              ...
              <table className="w-full bg-card rounded-xl border border-border">
                ...
                <tbody>
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">300x200x200 мм</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Тип гофры</td>
                    <td className="p-4 text-muted-foreground">Т22</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Плотность</td>
                    <td className="p-4 text-muted-foreground">300 г/м²</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Допнагрузка</td>
                    <td className="p-4 text-muted-foreground">до 15 кг</td>
                  </tr>
...
export default CorrugatedBox300;
