      ...
      <section className="pt-32 pb-16 bg-secondary hero-pattern">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <span className="text-foreground">Стрейч-плёнка 17 мкм</span>
          </nav>

          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl md:text-6xl font-bold text-primary-foreground mb-6">
                Стрейч-плёнка 17 мкм
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                Эластичная плёнка для ручной упаковки легких и средних грузов
              </p>
            ...
            <div className="relative">
              <img
                src={stretchFilm}
                alt="Стрейч-плёнка 17 мкм TuranPET"
              ...
              <table className="w-full bg-card rounded-xl border border-border">
                ...
                <tbody>
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">17 мкм</td>
                  </tr>
                  <tr className="border-b border-border">
                  ...
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">150-200 м</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Тип намотки</td>
                    <td className="p-4 text-muted-foreground">Ручная</td>
                  </tr>
                  <tr className="border-b border-border last:border-0">
                    <td className="p-4 font-medium text-foreground">Цвет</td>
                    <td className="p-4 text-muted-foreground">Прозрачный</td>
                  </tr>
                </tbody>
              </table>
            </div>
