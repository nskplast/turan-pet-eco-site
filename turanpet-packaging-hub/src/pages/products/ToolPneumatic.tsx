      ...
      <section className="pt-32 pb-16 bg-secondary hero-pattern">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <span className="text-foreground">Пневматический инструмент</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Профессиональный пневматический инструмент для быстрого натяжения и крепления ПЭТ-ленты
              </p>
            ...
            <div className="relative">
              <img
                src={tools}
                alt="Пневматический инструмент TuranPET"
          ...
          <div className="max-w-4xl mx-auto">
              ...
              <table className="w-full bg-card rounded-xl border border-border">
                ...
                <tbody>
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">Пневматический</td>
                  </tr>
                  <tr className="border-b border-border">
                  ...
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">до 3000 Н</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Материал корпуса</td>
                    <td className="p-4 text-muted-foreground">Металл</td>
                  </tr>
                  <tr className="border-b border-border last:border-0">
                    <td className="p-4 font-medium text-foreground">Вес</td>
                    <td className="p-4 text-muted-foreground">2.5 кг</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="mt-8 p-6 bg-card rounded-xl border border-border">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center text-muted-foreground">
                  <div className="w-1.5 h-1.5 bg-primary rounded-full mr-3" />
                  Промышленная упаковка тяжелых грузов
                </li>
                <li className="flex items-center text-muted-foreground">
                  <div className="w-1.5 h-1.5 bg-primary rounded-full mr-3" />
                  Складская логистика
        ...
        <div className="container-wide">
          <div className="p-12 rounded-2xl bg-secondary text-center">
            <h2 className="text-4xl font-bold text-primary-foreground mb-4">
              Заказать пневматический инструмент
            </h2>
