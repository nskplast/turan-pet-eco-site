      ...
      <section className="pt-32 pb-16 bg-secondary hero-pattern">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <span className="text-foreground">ПЭТ-лента 15мм</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Универсальная полиэстеровая лента шириной 15мм для средних и тяжелых грузов
              </p>
              ...
              <table className="w-full bg-card rounded-xl border border-border">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">0.6 мм, 0.8 мм</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Разрывная нагрузка</td>
                    <td className="p-4 text-muted-foreground">550 кг</td>
                  </tr>
                  <tr className="border-b border-border">
...
export default PETStrapping15mm;
