      ...
      <section className="pt-32 pb-16 bg-secondary hero-pattern">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <span className="text-foreground">Коробка 600x400x400</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Большая усиленная гофрокоробка для крупногабаритных и тяжелых товаров
              </p>
            ...
            <div className="relative">
              <img
                src={corrugatedBoxes}
                alt="Коробка 600x400x400 TuranPET"
              ...
              <table className="w-full bg-card rounded-xl border border-border">
                ...
                <tbody>
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">600x400x400 мм</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Тип гофры</td>
                    <td className="p-4 text-muted-foreground">Т24</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Плотность</td>
                    <td className="p-4 text-muted-foreground">500 г/м²</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Допнагрузка</td>
                    <td className="p-4 text-muted-foreground">до 40 кг</td>
                  </tr>
            ...
            <div className="mt-8 p-6 bg-card rounded-xl border border-border">
              ...
              <ul className="space-y-2">
                <li className="flex items-center text-muted-foreground">
                  ...
                  Упаковка крупногабаритных товаров
                </li>
                <li className="flex items-center text-muted-foreground">
                  <div className="w-1.5 h-1.5 bg-primary rounded-full mr-3" />
...
export default CorrugatedBox600;
