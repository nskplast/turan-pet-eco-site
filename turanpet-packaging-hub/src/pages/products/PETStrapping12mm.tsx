      ...
      <section className="pt-32 pb-16 bg-secondary hero-pattern">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <span className="text-foreground">ПЭТ-лента 12мм</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Высокопрочная полиэстеровая лента шириной 12мм для легких и средних грузов
              </p>
              ...
              <table className="w-full bg-card rounded-xl border border-border">
                ...
                <tbody>
                  <tr className="border-b border-border">
                    ...
                    <td className="p-4 text-muted-foreground">12 мм</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Толщина</td>
                    <td className="p-4 text-muted-foreground">0.5 мм, 0.6 мм</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Разрывная нагрузка</td>
                    <td className="p-4 text-muted-foreground">400 кг</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Длина в рулоне</td>
                    <td className="p-4 text-muted-foreground">1000 м, 1500 м</td>
                  </tr>
            ...
            <div className="mt-8 p-6 bg-card rounded-xl border border-border">
              ...
              <ul className="space-y-2">
                <li className="flex items-center text-muted-foreground">
                  ...
                  Упаковка легких и средних грузов
                </li>
                <li className="flex items-center text-muted-foreground">
                  <div className="w-1.5 h-1.5 bg-primary rounded-full mr-3" />
...
export default PETStrapping12mm;
