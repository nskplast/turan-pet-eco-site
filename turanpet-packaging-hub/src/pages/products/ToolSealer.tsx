      ...
      <section className="pt-32 pb-16 bg-secondary hero-pattern">
        <div className="container-wide">
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            <span>/</span>
            <span className="text-foreground">Ручной закаточник</span>
          </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Профессиональный ручной инструмент для крепления скоб на ПЭТ-ленту
              </p>
            ...
            <div className="relative">
              <img
                src={tools}
                alt="Ручной закаточник TuranPET"
          ...
          <div className="max-w-4xl mx-auto">
            <div className="overflow-x-auto">
              <table className="w-full bg-card rounded-xl border border-border">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Усилие закатки</td>
                    <td className="p-4 text-muted-foreground">до 1500 Н</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="p-4 font-medium text-foreground">Материал корпуса</td>
                    <td className="p-4 text-muted-foreground">Прочный пластик, металл</td>
                  </tr>
                  <tr className="border-b border-border last:border-0">
                    <td className="p-4 font-medium text-foreground">Вес</td>
                    <td className="p-4 text-muted-foreground">1.2 кг</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="mt-8 p-6 bg-card rounded-xl border border-border">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center text-muted-foreground">
                  <div className="w-1.5 h-1.5 bg-primary rounded-full mr-3" />
                  Упаковка грузов различных типов
                </li>
              </ul>
            </div>
          </div>
